...
fig1, ax1 = plot.subplots(axwidth=5, tight=True, proj="ortho", proj_kw={"lon_0": 220})
...
map1 = ax1.contourf(
    ...
    asst["lat"],
    corr_asst_nino34,
    levels=plot.arange(-1.0, 1.0, 0.2),
    cmap="RdBu_r",
)
...
fig1.savefig("ex01.jpg", transparent=True, dpi=300, bbox_inches="tight", pad_inches=0)
