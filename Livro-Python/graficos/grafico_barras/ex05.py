...
x1 = [y - 0.13 for y in r1]  # Valores do eixo x para desenhar a primeira barra.
x2 = [y + 0.13 for y in r1]  # Valores do eixo x para desenhar a segunda barra.
...
plt.xlabel("Tipos de eventos", fontsize=8)
